					...
					<div className="space-y-3 rounded-md bg-gray-50 p-4">
						...
						<label className="flex items-center space-x-3">
							<input
								...
								onChange={(e) =>
									handleSyncOptionChange("updateCardModels", e.target.checked)
								}
						...
						<label className="flex items-center space-x-3">
							<input
								...
								onChange={(e) =>
									handleSyncOptionChange("addNoteTypes", e.target.checked)
								}
								className="rounded border-gray-300 text-blue-600 focus:ring-blue-500"
							/>
						...
						<label className="flex items-center space-x-3">
							<input
								...
								onChange={(e) =>
									handleSyncOptionChange("addDecks", e.target.checked)
								}
								className="rounded border-gray-300 text-blue-600 focus:ring-blue-500"
							/>
							<div className="flex items-center space-x-2">
						...
						<label className="flex items-center space-x-3">
							<input
								...
								onChange={(e) =>
									handleSyncOptionChange("addCardTypes", e.target.checked)
								}
								className="rounded border-gray-300 text-blue-600 focus:ring-blue-500"
							/>
							<div className="flex items-center space-x-2">
						...
						<label className="flex items-center space-x-3">
							<input
								...
								onChange={(e) =>
									handleSyncOptionChange("addFields", e.target.checked)
								}
								className="rounded border-gray-300 text-blue-600 focus:ring-blue-500"
							/>
							<div className="flex items-center space-x-2">
						...
						<label className="flex items-center space-x-3">
							<input
								...
								onChange={(e) =>
									handleSyncOptionChange("syncToCloud", e.target.checked)
								}
								className="rounded border-gray-300 text-blue-600 focus:ring-blue-500"
							/>
