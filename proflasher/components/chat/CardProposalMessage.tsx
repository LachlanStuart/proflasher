...
export function CardProposalMessage({
    ...
    const { language, activeCardTypes, setActiveCardTypes, template } =
        useFlashcard();
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            const cardToSubmit = rowToColumnOriented(
                editedRowCards[selectedCard]!,
                                            ...
                                            <input
                                                ...
                                                onChange={(e) => {
                                                    if (e.target.checked) {
                                                        ...
                                                        setActiveCardTypes(
                                                            activeCardTypes.filter((t) => t !== type),
                                                        );
                                                    }
                                                }}
